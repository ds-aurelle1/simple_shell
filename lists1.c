...
/**
 * list_to_strings - displays array of str
...
/**
 * print_list - writes all parameters of list
...
/**
 * node_starts_with - displays node beginning with prefix
...
/**
 * get_node_index - obtains node index
 * @head: head node
 * @node: node
 * Return: -1 | node index
 */
